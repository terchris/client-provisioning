...
#
# Purpose:
#   Runs uninstall test (uninstall.ps1 self-verifies exe and registry removal).
#
# Author: Ops Team
# Created: February 2026
#
# Run from USB: powershell -ExecutionPolicy Bypass -File "D:\rancher-desktop\tests\run-tests-uninstall.ps1"
...
$SCRIPT_NAME        = "Rancher Desktop Uninstall Tests"
$SCRIPT_VER         = "0.2.0"
$SCRIPT_DESCRIPTION = "Runs uninstall test (uninstall.ps1 self-verifies exe and registry removal)."
...
function Show-Help {
    ...
    Write-Host ""
    Write-Host "Tests:"
    Write-Host "  1. Uninstall (runs uninstall.ps1: stop, MSI remove, verify exe + registry gone)"
    Write-Host ""
...
Write-Host ""
Write-Host "================================================================"
log_info "Test 1: Uninstall (runs uninstall.ps1 with full verification)"
Write-Host "================================================================"
Write-Host ""
...
log_info "Running uninstall.ps1 (stops processes, uninstalls, verifies removal)..."
Write-Host ""
...
if ($uninstallExit -eq 0) {
    Test-Pass "uninstall.ps1 (exit code 0 -- uninstalled, exe removed, registry cleaned)"
} else {
...
if ($overallPass -and $allPassed) {
    ...
    Write-Host ""
    log_info "Rancher Desktop has been removed."
