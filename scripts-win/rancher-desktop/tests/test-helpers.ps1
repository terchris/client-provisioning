...
#
# Purpose:
#   Shared test functions for Rancher Desktop USB tests. Dot-source this from test scripts.
#
# Author: Ops Team
...
$SCRIPT_NAME        = "Rancher Desktop Test Helpers"
$SCRIPT_VER         = "0.2.0"
$SCRIPT_DESCRIPTION = "Shared test functions for Rancher Desktop USB tests."
