...
The **IMPLEMENTATION RULES** blockquote ensures Claude Code reads the workflow and plan guidelines before starting work. The **UPDATE** reminder prevents drift — without it, Claude tends to implement without tracking progress in the plan file.
