...
curl -fsSL "https://github.com/helpers-no/devcontainer-toolbox/releases/download/v1.2.0/toolbox-scripts.tar.gz" \
...
- Issue [#43](https://github.com/helpers-no/devcontainer-toolbox/issues/43) -- Ship machine-readable tool inventory (completed, created `tools.json`)
